...
import (
	...
	"tinyETL/tinyETLengine/components/csvOutput"
	...
	"tinyETL/tinyETLengine/components/innerJoin"
	...
	"tinyETL/tinyETLengine/components/outerJoin"
	...
	"tinyETL/tinyETLengine/components/rightJoin"
	...
	"tinyETL/tinyETLengine/components/sortRecords"
...
func GetComponents(name string, id string, parameters interface{}) (abstractComponents.VirtualComponents, error) {
	...
	} else if name == "sortRecords" {
		return sortRecords.NewComponents(id, parameters)
	...
	} else if name == "innerJoin" {
		return innerJoin.NewComponents(id, parameters)
	} else if name == "csvOutput" {
		return csvOutput.NewComponents(id, parameters)
	} else if name == "outerJoin" {
		return outerJoin.NewComponents(id, parameters)
	} else if name == "rightJoin" {
		return rightJoin.NewComponents(id, parameters)
